...
class DoublePreference(
    ...
    override fun getValue(thisRef: Any, property: KProperty<*>): Double = java.lang.Double.longBitsToDouble(pref.getLong(property.name, java.lang.Double.doubleToLongBits(defValue)))

    override fun setValue(thisRef: Any, property: KProperty<*>, value: Double)= pref.edit().putLong(property.name, java.lang.Double.doubleToRawLongBits(value)).apply()
}
